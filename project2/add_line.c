...
int main() {
   ...
   add_line_after(&doc, paragraph_number, line_number, "First Paragraph, Second line");
   add_line_after(&doc, paragraph_number, line_number+1, "First Paragraph, Third line");
