...
/*
13. This function is similar to load_document, but it loads data from a file
and not an array. By default, this function adds a new paragraph. 
Args:
    - Document *doc
    - const char *filename
Returns:
...
int load_file(Document *doc, const char *filename) {
    ...
    if (doc && filename && (input = fopen(filename, "r")) != NULL) {
        ...
        /* by default make a new paragraph */
        add_paragraph_after(doc, 0);
        
        /* fgets() to read lines */
        while (fgets(line, 1026, input) != NULL) {

            if (strlen(line) <= 1024 && strcmp(line, "") != 0) {
                /* if the line does contain spaces, make a new paragraph */
                if (check_for_spaces(line) == FAILURE) {
                    /* if cannot add more paragraphs, stop here*/
                ...
                /* if not spaces, then add line to current paragraph */
                if (check_for_spaces(line) == SUCCESS) {
                    line[strcspn(line, "\n")] = 0;
                    append_line(doc, paragraph, line);
                }
            }
        }
        fclose(input);
...
/*
14. This function prints the paragraphs of the specified file and overwrites
the file. Each paragraph separated by a newline.
Args:
    - Document *doc
    - const char *filename
Returns:
...
int save_document(Document *doc, const char *filename) {
    ...
    /* null check */
    if (doc && filename && (output = fopen(filename, "r"))) {
